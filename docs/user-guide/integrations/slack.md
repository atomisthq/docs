<img style="float:right; margin-top:0px; margin-right:0px; margin-bottom:10px; margin-left:10px;" src="../images/slack-logo.png" height="100px" width="100px" alt"Slack logo"/>
