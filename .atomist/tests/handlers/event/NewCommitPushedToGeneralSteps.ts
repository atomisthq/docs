...
Given("the NewCommitPushedToGeneral event handler is registered", (world: EventHandlerScenarioWorld) => {
    world.registerHandler("NewCommitPushedToGeneral");
});
...
Then("that message should target the general channel", (world: EventHandlerScenarioWorld) => {
